...
body = body.replace('<div data-v-63a3e543="" class="h-full w-1000px relative"', 
                    '<div data-v-63a3e543="" class="h-full w-1000px" style="position: fixed; bottom: 0; width: 100%; max-width: 1000px;"');
...
body = body.replace('<div data-v-47ffe1ec class="pl-12px pb-136px z-4 absolute left-full pt-12px" id="r-menu"',
                    '<div data-v-47ffe1ec class="pl-12px pb-136px z-4" id="r-menu" style="position: fixed; bottom: 0; left: 0; width: 100%; max-width: 1000px;"');
